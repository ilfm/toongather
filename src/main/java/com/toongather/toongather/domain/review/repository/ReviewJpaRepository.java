...
public class ReviewJpaRepository {
   ...
   * @return 정렬된 SearchReviewResponse 리스트
   */
  public List<SearchReviewResponse> findAllWithSortType(ReviewSortType sort) {

    String sql = "select new com.toongather.toongather.domain.review.dto.SearchReviewResponse"
    ...
    return em.createQuery(sql, SearchReviewResponse.class)
        .getResultList();
  }
